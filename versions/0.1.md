...
#### <a name="serviceMetadataObject"></a>Service Metadata Object
...
Field Pattern | Type | Description
---|:---:|---
<a name="serviceMetadataProperties"></a>properties | Map[`string`, [Service Metadata Item Object](#serviceMetadataItemObject)] | A map containing information for each metadata item. Each property key has a name for the metadata item.
<a name="serviceMetadataExample"></a>example | Any | A free-form property to include an example for this metadata instance.
<a name="serviceMetadataExternalDocs"></a>externalDocs | [External Documentation Object](https://github.com/OAI/OpenAPI-Specification/blob/master/versions/2.0.md#externalDocumentationObject) | Additional external documentation.
...
#### <a name="serviceMetadataItemObject"></a>Service Metadata Item Object
